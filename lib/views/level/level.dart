          ...
          return FutureBuilder(
              ...
              builder: (context, snapshot) {
                if (!snapshot.hasData) {
                  ...
                  mirrors = map.levelMap.entries
                      .where((element) => element.value is Mirror)
                      .toList();
                    ...
                    mirrorsView.add(Positioned(
                      ...
                      child: SizedBox(
                          ...
                          child: Transform.rotate(
                            ...
                            child: (snapshot.data![Mirror])[
                                (m.value as Mirror).isLaserTouching ? 0 : 1],
                          )),
                    ));
                  }
                  ...
                  for (var c in map.levelMap.entries
                      .where((element) => element.value is Coin)
                      .toList()) {
                  ...
                  for (var c in map.levelMap.entries
                      .where((element) => element.value is LaserBeamCross)
                      .toList()) {
                    coinView.add(Positioned(
                      top: ((MediaQuery.of(context).size.height -
                                  (sizeOneCell * height)) /
                  ...
                  for (var c in map.levelMap.entries
                      .where((element) => element.value is LaserBeamVertical)
                      .toList()) {
                    coinView.add(Positioned(
                      top: ((MediaQuery.of(context).size.height -
                                  (sizeOneCell * height)) /
                  ...
                  for (var c in map.levelMap.entries
                      .where((element) => element.value is LaserBeamHorizontal)
                      .toList()) {
                    coinView.add(Positioned(
                      top: ((MediaQuery.of(context).size.height -
                                  (sizeOneCell * height)) /
                  ...
                  Position cursorPosition = switch (map.playerFacing) {
                    Direction.up =>
                      Position(playerPosition.x, playerPosition.y - 1),
                    Direction.down =>
                      Position(playerPosition.x, playerPosition.y + 1),
                    Direction.left =>
                      Position(playerPosition.x - 1, playerPosition.y),
                    Direction.right =>
                      Position(playerPosition.x + 1, playerPosition.y),
                    Direction.none =>
                      ...
                      children: <Widget>[
                            ...
                            Positioned(
                              top: ((MediaQuery.of(context).size.height -
                                          (sizeOneCell * height)) /
                                      2) +
                                  (sizeOneCell * playerPosition.y),
                              left: ((MediaQuery.of(context).size.width -
                                          (sizeOneCell * width)) /
                                      2) +
                                  (sizeOneCell * playerPosition.x),
                              child: SizedBox(
                                width: sizeOneCell,
                                height: sizeOneCell,
                                child: (snapshot
                                    .data![Player])[map.getPlayerFacingAsInt()],
                              ),
                            ),
                            Positioned(
                                top: ((MediaQuery.of(context).size.height -
                                            (sizeOneCell * height)) /
                                        2) +
                                    (sizeOneCell * cursorPosition.y),
                                left: ((MediaQuery.of(context).size.width -
                                            (sizeOneCell * width)) /
                                        2) +
                                    (sizeOneCell * cursorPosition.x),
                                child: SizedBox(
                                  width: sizeOneCell,
                                  height: sizeOneCell,
